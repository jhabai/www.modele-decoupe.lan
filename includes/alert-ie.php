 ...
 * edit jh : z-index + min-width
 
 * Alert-IE.php affiche un message d'alerte invitant les utilisateurs d'IE9 et inférieur à utiliser de préférence un navigateur à jour, tel que Chrome ou Firefox.
 * =================================================================================
 */
...
<div id="alert-ie">
	<div>
		<h2>Attention, vous utilisez Internet Explorer <span id="ie-detect"></span></h2> <br>
		<p>
			Ce navigateur internet est obsol&egrave;te, pour votre s&eacute;curit&eacute; et votre confort, nous vous recommandons d'utiliser un navigateur plus r&eacute;cent et &agrave; jour.
...
/**
 * navigator est un objet Javascript qui permet d'afficher certaines informations du navigateur
 * Documentation : http://www.javascriptkit.com/javatutors/navigator.shtml
 */
...
/**
 * Si la version détectée est Internet Explorer (via MSIE)
 * Alors on stock le nom du navigateur et ça version
 */
...
/**
 * <span> qui affichera le nom et la version d'internet explorer
 */ 

document.getElementById('ie-detect').innerHTML = version;
